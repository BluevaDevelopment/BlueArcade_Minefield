...
- `/baa game [arena_id] minefield finishline set` — Select and save the finish line region.
- `/baa game [arena_id] minefield floor set` — Select and save the minefield floor region.

## Technical details
- **Minigame ID:** `minefield`
